  ...
  return (
    <div className='bg-[#000300] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
      ...
      <div className="text-center mt-8 lg:col-span-3">
        <p className="text-sm text-gray-500">&copy; {currentYear} Your Website. All rights reserved.</p>
        </div>
...
//   return (
//     <footer className='bg-[#000300] py-16 px-4 text-gray-300'>
